...
if (isset($_POST['submit'])) {
    ...
    $sql="INSERT INTO `properties_form_data`(`name`, `price`, `image`, `discription`, `status`) 
    VALUES ('$name','$price','$filename','$discription','$status')";
                        ...
                        <div class="col-12 col-lg-10">
                            <div class="card mt-5" style="border-radius: 1rem;">
                                <div class="card-body p-5">
                                    ...
                                    <h1 class="mb-5 text-center">Properties Form</h1>
                                    ...
                                    <form id="form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-lg-6 col-xl-6 mb-4">
                                                <div class="form-outline mb-4">
                                                    <input type="number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1').replace(/^0[^.]/, '0');" name="price" id="input"
                                                        class="form-control" />
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6 col-xl-6">
                                                ...
                                                <!-- discription input -->
                                                <div class="form-outline mb-4">
                                                    <input type="disc" name="discription" id="input"
                                                        class="form-control" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-outline mb-4">
                                            <textarea class="form-control" id="input" name="status"
                                                rows="4"></textarea>
                                        ...
                                        <button type="submit" name="submit"
                                            class="btn btn-secondary btn-rounded btn-block">Sumbit</button>
                                        </div>
                                        <div class="col-md-3 col-sm-3 col-lg-3 col-xl-3"></div>
                                        </div>
