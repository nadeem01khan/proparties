...
if(isset($_POST['submit'])){
    ...
    $sql="INSERT INTO `appointment`(`name`, `email`, `phone`, `metting_date`, `metting_time`, `message`) 
    VALUES ('$name','$email','$phone','$metting_date','$metting_time','$message')";
                            ...
                            <form id="form" role="form" method="post">
                                <div class="controls">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="birthdayDate" class="form-label">Meeting Date</label>

                                                <input class="form-control" type="date" name="metting_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="birthdayDate" class="form-label">Meeting Time</label>
                                                <input class="form-control" type="time" name="metting_time">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="birthdayDate" class="form-label">message</label>
